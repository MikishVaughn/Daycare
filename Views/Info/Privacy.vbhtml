...
<div style="font-family: 'Knockout 31 4r', HelveticaNeue-CondensedBold, Helvetica, Arial, sans-serif; font-weight: 400; color: black; margin-left: auto; margin-right: auto; text-align: center; max-width: 90%;">
    ...
    <div style="padding: 5px; width: 98%; text-align: left; color: black;">
        ...
        <div class="gradientheading">What personal information do we collect from the people that visit our blog, website or app?</div>
        <div class="p_div">When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address or other details to help you with your experience.</div>

        <div class="gradientheading">When do we collect information?</div>
        <div class="p_div">We collect information from you when you register on our site or enter information on our site.</div>

        <div class="gradientheading">How do we use your information?</div>
        <div class="p_div">
            We may use the information we collect from you when you register, make a purchase, sign up for our newsletter, respond to a survey or marketing communication, surf the website, or use certain other site features in the following ways:
        </div>
        <div class="p_div_bullet">To personalize user's experience.</div>
        <div class="p_div_bullet">To improve our website in order to better serve you.</div>
        <div class="p_div_bullet">To allow us to better service you in responding to your customer service requests.</div>
        <div class="p_div_bullet">To administer a contest, promotion, survey or other site feature.</div>
        <div class="p_div_bullet">To send periodic emails regarding your order or other products and services.</div>

        <div class="gradientheading">How do we protect visitor information?</div>
        <div class="p_div">We do not use vulnerability scanning and/or scanning to PCI standards.</div>
        <div class="p_div">We use regular Malware Scanning.</div>
        <div class="p_div">We do not use an SSL certificate.</div>
        <div class="p_div">We only provide articles and information, we never ask for personal or private information other than name and email addresses.</div>

        <div class="gradientheading">Do we use "cookies"?</div>
        <div class="p_div">
        ...
        <div class="p_div">We use cookies to:</div>
        <div class="p_div_bullet">Understand and save user"s preferences for future visits.</div>
        <div class="p_div">You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your browser (like Internet Explorer) settings. Each browser is a little different, so look at your browser"s Help menu to learn the correct way to modify your cookies.</div>
        <div class="p_div">
        ...
        <div class="gradientheading">Third Party Disclosure</div>
        <div class="p_div">
            We do not sell, trade, or otherwise transfer to outside parties your personally
            identifiable information.
        </div>

        <div class="gradientheading">Third party links</div>
        <div class="p_div">
        ...
        <div class="gradientheading">Google</div>
        <div class="p_div">
        ...
        <div class="p_div">We have implemented the following:</div>
        <div class="p_div_bullet">Demographics and Interests Reporting</div>
        <div class="p_div">
        ...
        <div class="gradientheading">California Online Privacy Protection Act</div>
        <div class="p_div">
        ...
        <div class="p_div">Users will be notified of any privacy policy changes:</div>
        <div class="p_div_bullet">On our Privacy Policy Page</div>
        <div class="p_div">Users are able to change their personal information:</div>
        <div class="p_div_bullet">By logging in to their account </div>
        <div class="p_div">How does our site handle do not track signals?</div>
        <div class="p_div">
        ...
        <div class="p_div">Does our site allow third party behavioral tracking?</div>
        <div class="p_div">It's also important to note that we do not allow third party behavioral tracking</div>

        <div class="gradientheading">COPPA (Children Online Privacy Protection Act)</div>
        <div class="p_div">
        ...
        <div class="p_div">We do not specifically market to children under 13.</div>

        <div class="gradientheading">Fair Information Practices</div>
        <div class="p_div">
        ...
        <div class="p_div">We will notify the users via email</div>
        <div class="p_div_bullet">Within 7 business days</div>
        <div class="p_div">We will notify the users via in site notification</div>
        <div class="p_div_bullet">Within 7 business days</div>
        <div class="p_div">
        ...
        <div class="gradientheading">CAN SPAM Act</div>
        <div class="p_div">
            The CAN-SPAM Act is a law that sets the rules for commercial email, establishes
            requirements for commercial messages, gives recipients the right to have emails
            stopped from being sent to them, and spells out tough penalties for violations.
        </div>
        <div class="p_div">We collect your email address in order to:</div>
        <div class="p_div_bullet">Send information, respond to inquiries, and/or other requests or questions.</div>
        <div class="p_div">To be in accordance with CANSPAM we agree to the following:</div>
        <div class="p_div_bullet">NOT use false, or misleading subjects or email addresses</div>
        <div class="p_div_bullet">Identify the message as an advertisement in some reasonable way</div>
        <div class="p_div_bullet">Include the physical address of our business or site headquarters</div>
        <div class="p_div_bullet">Monitor third party email marketing services for compliance, if one is used.</div>
        <div class="p_div_bullet">Honor opt-out/unsubscribe requests quickly</div>
        <div class="p_div_bullet">Allow users to unsubscribe by using the link at the bottom of each email</div>
        <div class="p_div">If at any time you would like to unsubscribe from receiving future emails, you can email us at:</div>
        <div class="p_div_bullet">Follow the instructions at the bottom of each email.</div>
    </div>
</div>
